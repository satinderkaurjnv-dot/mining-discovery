...
export const GlobeHero: React.FC = () => {
  ...
  return (
    <section className="relative w-full bg-[#DFE7F3] text-[#0B1F3A]">
      ...
      <div
        ref={copyRef}
        className="relative z-10 flex flex-col items-center px-6 pb-8 pt-[clamp(56px,calc(40vh-224px),112px)] text-center sm:px-10 sm:pt-[clamp(60px,calc(48vh-316px),132px)] lg:pt-[clamp(64px,calc(48vh-320px),160px)]"
      >
        <p className="hero-rise [animation-delay:60ms] font-mono text-[10px] font-semibold uppercase leading-none tracking-[0.2em] text-[#9E7208] sm:text-[11px] sm:tracking-[0.22em]">
          MINING MEDIA &times; MARKETING &times; INVESTOR REACH
        </p>

        <h1 className="hero-rise [animation-delay:160ms] mt-4 max-w-[1100px] font-geist text-[clamp(2.5rem,5.8vw,5.5rem)] font-bold uppercase leading-[1.02] tracking-[-0.02em] text-[#0B1F3A] sm:mt-5">
          MAKE YOUR MINING<br />STORY IMPOSSIBLE TO<br />IGNORE.
        </h1>

        <p className="hero-rise [animation-delay:260ms] mt-6 max-w-[720px] font-geist text-[clamp(1rem,1.35vw,1.25rem)] font-normal leading-[1.5] tracking-[-0.005em] text-[#475569] sm:mt-7">
        ...
        <div className="hero-rise [animation-delay:360ms] mt-7 flex w-full flex-col items-stretch gap-3 sm:mt-8 sm:w-auto sm:flex-row sm:items-center sm:gap-4">
          ...
          <Link
            href="/#services"
            className="group inline-flex items-center justify-center gap-2 rounded-lg border border-[#0B1F3A]/25 bg-white/40 backdrop-blur-sm px-7 py-3.5 font-sans text-[13px] font-semibold uppercase tracking-[0.08em] text-[#0B1F3A] transition-colors duration-200 hover:border-[#0B1F3A] hover:bg-white/70 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0B1F3A] focus-visible:ring-offset-2"
          >
