...
const MINING_SITES: MiningSite[] = [
  {
    ...
    country: "Canada",
    detail: "Athabasca & Abitibi Corridors",
    commodities: "Gold, Uranium & Critical Minerals",
    coordsLabel: "56.0° N, 106.0° W",
    badge: "Tier 1 Hub",
    lat: 56,
    lng: -106,
    labelOnMobile: true,
  },
  {
    ...
    country: "Chile",
    detail: "Atacama Copper & Lithium Belt",
    commodities: "Copper, Lithium & Molybdenum",
    coordsLabel: "30.0° S, 71.0° W",
    badge: "Global Producer",
    lat: -30,
    lng: -71,
    labelOnMobile: true,
  },
  {
    ...
    region: "Europe",
    country: "Sweden",
    detail: "Kiruna & Skellefte Mineral Field",
    commodities: "Iron Ore, Rare Earths & Zinc",
    coordsLabel: "60.0° N, 18.0° E",
    badge: "Clean Tech Hub",
    lat: 60,
    lng: 18,
    labelOnMobile: true,
  },
  {
    ...
    detail: "Bushveld & Witwatersrand Basin",
    commodities: "PGMs, Gold, Diamonds & Chrome",
    coordsLabel: "30.0° S, 24.0° E",
    badge: "Historic Major",
    lat: -30,
    lng: 24,
    labelOnMobile: true,
  },
  {
    ...
    region: "Asia",
    country: "Mongolia",
    detail: "South Gobi Copper-Gold Arc",
    commodities: "Copper, Gold & Coking Coal",
    coordsLabel: "46.0° N, 104.0° E",
    badge: "High Growth",
    lat: 46,
    lng: 104,
    labelOnMobile: true,
  },
  {
    ...
    detail: "Pilbara & Yilgarn Craton",
    commodities: "Iron Ore, Gold & Battery Metals",
    coordsLabel: "25.0° S, 122.0° E",
    badge: "Export Epicenter",
    lat: -25,
    lng: 122,
    labelOnMobile: true,
  },
  {
    ...
    detail: "Geological Survey & Treaty Baseline",
    commodities: "Scientific Ice & Crustal Research",
  ...
  const handleSelectRegion = useCallback((siteId: string | null) => {
    ...
    if (siteId) {
      ...
      if (site) {
        ...
        focusRef.current = { lat: site.lat, lng: site.lng, tiltBias, weight: 0.95 };
        // Smoothly resume free continuous rotation from the new viewpoint
        setTimeout(() => {
                        ...
                        >
                          ...
                          {isActive && (
                            <div className="mt-1 border-t border-[#0B1F3A]/8 pt-1">
                              ...
                              {site.commodities && (
                                <span className="mt-0.5 block font-geist text-[8.5px] font-normal leading-tight text-[#57595E]">
                                  {site.commodities}
                                </span>
                              )}
                              {site.coordsLabel && (
