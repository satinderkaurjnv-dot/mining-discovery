...
export const GlobeHero: React.FC = () => {
  ...
  return (
    <section className="relative w-full bg-[#DFE7F3] text-[#0B1F3A]">
      ...
      >
        <p className="hero-rise [animation-delay:60ms] font-mono text-[9px] sm:text-[11px] font-semibold uppercase leading-none tracking-[0.16em] sm:tracking-[0.22em] text-[#9E7208] max-w-full break-words">
