        ...
        <div className="max-w-4xl">
          ...
          <div className="mt-8 space-y-6 text-base leading-relaxed font-medium text-gray-600">
            <p>
              ...
              <strong className="text-[#081121] font-bold">Gaurav Sharma</strong> and{" "}
              <strong className="text-[#081121] font-bold">Sagar Bakshi</strong> with a shared vision: to bring
