                ...
                {PURPOSES.map((purpose, index) => {
                  ...
                  return (
                    <li
                      ...
                      className={`group flex items-baseline gap-5 border-b border-[#E5E4DE] py-3.5 cursor-pointer rounded-lg px-2 -mx-2 transition-all duration-300 ${
                        isActive ? "bg-[#B8860B]/[0.06]" : "hover:bg-[#0B1F3A]/[0.03]"
                      }`}
                    >
                      <span
                        className={`font-mono text-[11px] tabular-nums transition-colors duration-300 ${
                          isActive ? "text-[#B8860B] font-semibold" : "text-[#B8860B]/40 group-hover:text-[#B8860B]"
                        }`}
                      >
                      ...
                      <span
                        className={`text-base font-medium transition-all duration-300 sm:text-lg ${
                          isActive
                            ? "translate-x-1 text-[#0B1F3A] font-semibold"
                            : "translate-x-0 text-[#57595E]/60 group-hover:translate-x-1 group-hover:text-[#0B1F3A]"
                        }`}
                      >
                        {purpose.title}
                      </span>
