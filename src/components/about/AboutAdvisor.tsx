      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex flex-col gap-10">
          <div className="group hover:shadow-[#B8860B]/10 relative flex w-full flex-col items-start gap-8 overflow-hidden rounded-3xl border border-gray-100 bg-white p-6 shadow-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:flex-row sm:items-center sm:p-10">
            ...
            <div className="bg-[#081121] flex size-20 shrink-0 self-start sm:size-28 items-center justify-center rounded-2xl text-3xl sm:text-4xl font-black text-white shadow-lg">
              LS
            </div>
            <div className="flex-1 text-left">
              <h3 className="text-[#081121] mb-2 text-2xl sm:text-3xl font-black tracking-tighter uppercase">
                Laura Stein
              </h3>
