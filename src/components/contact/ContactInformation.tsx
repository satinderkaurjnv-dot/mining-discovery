            ...
            <div className="relative z-10 flex h-full flex-col">
              ...
              <div className="flex flex-col gap-7">
                ...
                <div className="flex items-start gap-5">
                  <Mail className="mt-0.5 size-5 shrink-0 text-[#FF6B4A]" />
                  <a
                    href="mailto:info@miningdiscovery.com"
                    className="text-sm text-white transition-colors hover:text-[#FF6B4A]"
                  >
                ...
                {/* Address */}
                <div className="flex items-start gap-5">
                  <MapPin className="mt-0.5 size-5 shrink-0 text-[#FF6B4A]" />
              ...
              <div className="mt-auto pt-16">
                <div className="flex items-center gap-3">
                  <a
                    ...
                    aria-label="Facebook"
                    className="flex size-9 items-center justify-center rounded-full bg-white/10 text-white transition-colors hover:bg-[#FF6B4A] hover:text-white"
                  >
